...
import org.god.jmu.models.JMonitorUI;
...
public class JmuJacksonModule extends SimpleModule implements JacksonModuleRegistrar {
    ...
    public void setupModule(SetupContext context) {
        ...
        context.setMixInAnnotations(JMonitorUI.class, org.god.jmu.config.JmuJacksonModule.CustomizedSwaggerSerializer.class);
    ...
    private interface PropertyExampleSerializerMixin {
        @JsonSerialize(
                using = org.god.jmu.config.JmuJacksonModule.PropertyExampleSerializerMixin.PropertyExampleSerializer.class
        )
        Object getExample();
